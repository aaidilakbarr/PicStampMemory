    ...
    return (
      <View style={tw`flex-1 bg-background justify-center items-center px-6`}>
        ...
        <TouchableOpacity
          ...
          style={tw`px-6 py-3 bg-primary rounded-xl active:scale-95`}
        >
  ...
  return (
    <View style={tw`flex-1 bg-background`}>
      ...
      <View style={[tw`flex-row justify-between items-center px-5 pt-12 pb-4 border-b border-cream-dark`, { height: 96 }]}>
        <TouchableOpacity onPress={() => onNavigate('CREATE')} style={tw`active:scale-95 p-1`}>
      ...
      <View style={tw`px-8 pb-10 pt-4 items-center`}>
        ...
        <View style={tw`flex-row justify-between items-center w-full max-w-[280px] mb-8`}>
          ...
          <TouchableOpacity
            onPress={toggleFlash}
            style={tw`w-12 h-12 bg-cream-dark/40 border border-cream-dark/60 rounded-full justify-center items-center active:scale-90`}
          >
            {flash === 'on' ? (
          ...
          <TouchableOpacity
            ...
            disabled={capturing}
            style={[
              tw`w-20 h-20 rounded-full border border-primary/20 justify-center items-center active:scale-95`,
        ...
        <TouchableOpacity
          ...
          style={tw`flex-row items-center gap-3 active:scale-98`}
        >
